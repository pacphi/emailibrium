...
--
-- Dialect note (ADR-033): created_at/updated_at stay TEXT (matching the SQLite schema's
-- own type choice) with SQLite's now-timestamp default ported to an expression producing the identical
-- 'YYYY-MM-DD HH:MI:SS' UTC string shape.
