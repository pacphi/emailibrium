...
# Option B: Docker
make docker-secrets   # generate dev secrets (first time only)
make docker-up-dev    # start with hot-reload
```

**Prerequisites:** Rust 1.94+, Node.js 24+, pnpm 10.32+ — or just Docker.
...
- **Backend:** Rust (Axum 0.8), SQLite, 16 vector intelligence modules
...
| Vector Intelligence | HNSW indexing, SONA learning, K-means++ clustering, scalar/PQ/binary quantization |
| Frontend | React 19, TypeScript 5.9, Vite 6, TanStack Router + Query, Zustand, Tailwind CSS |
