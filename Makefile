...
help:
	...
	@echo "  dev-llm                - Start with built-in LLM (llama.cpp)"
	@echo "  clean                  - Clean all build artifacts"
	@echo "  clean-data             - Remove all local data (DB, vectors)"
	@echo "  clean-all              - Clean build artifacts + all local data"
	@echo ""
	@echo "$(BOLD)$(BLUE)═══ AI & Models ═════════════════════════════════════════════════════$(RESET)"
	@echo "  models                 - Show available LLM models"
	@echo "  embedding-models       - Show available embedding models"
	@echo "  download-model MODEL=x - Download a specific model"
	...
	@echo "  docker-down-volumes    - Stop + remove volumes (DESTROYS DATA)"
	...
	@echo "  docker-exec-frontend   - Shell into frontend container"
	@echo "  docker-health          - Health check all containers"
	@echo "  docker-clean           - Prune dangling Docker artifacts"
	...
	@echo "  release-push           - Push latest tag to trigger release"
