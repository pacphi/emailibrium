...
| **Operator** | setup/deployment/oauth guides, configuration-reference, compose files | + `secrets/README.md` (documents the secrets *mechanism*, which is this persona's job per phase 2's conventions) |
