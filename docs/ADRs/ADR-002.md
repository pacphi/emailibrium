...
- RESEARCH.md (Emailibrium internal) -- Identifies domain adaptation gap, multilingual gap, and short-query weakness as key concerns with the selected model.
